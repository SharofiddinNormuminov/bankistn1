...
const account3 = {
  ...
  movements: [2000, -200, 340, -300, -20, 500, 4000, -460],
  interestRate: 1.7,
  pin: 3333,
...
const printWelcome = function (name) {
  ...
  const greetings = new Map([
    [[5, 6, 7, 8, 9], 'Good Morning'],
    [[10, 11, 12, 13, 14], 'Good Day'],
    [[15, 16, 17, 18], 'Good Afternoon'],
    [[19, 20, 21, 22], 'Good Evening'],
    [[23, 0, 1, 2, 3, 4], 'Good Night'],
  ]);
...
const printMovements = function (account, sort = false) {
  ...
  move.forEach((move, i) => {
    ...
    const formattedMove = formatCur(move, account.locale, account.currency);
...
btnLogin.addEventListener('click', function (e) {
  ...
  if (currentAccount && currentAccount.pin === +inputLoginPin.value) {
    ...
    alert("Akkauntni to'g'ri kiriting sizda bunday akkount mavjud emas");
  }
});
...
btnTransfer.addEventListener('click', function (e) {
  ...
  if (
    ...
    alert(
      "login xato yoki pul o'tkazmasini o'tkazish uchun mablag' yetarli emas"
    );
  }
...
btnLoan.addEventListener('click', function (e) {
  ...
  if (
    ...
    alert("Insof sari baraka deydilar, kamroq qarz so'rasangizchi");
  }
...
btnClose.addEventListener('click', function (e) {
  ...
  if (
    ...
    alert("ayni vaqtda kirib turgan akkountingizni o'chira olasiz");
  }
